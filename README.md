...
```typescript
import { parseAssembly }       from '@/services/assembly-parser.service/assembly-parser.service';
import { parseInstructions }   from '@/services/instruction.parser.service';
import { encodeInstruction,
         decodeInstruction }   from '@/services/handler.registry.service';
import { formatDecodedInstruction } from '@/utils/format.utils';
